...
//
template <typename Ch>
class basic_istring : public string_base
{
public:
    ...
    basic_istring& assign(const_pointer str);
    basic_istring& assign(const basic_istring& str);
    basic_istring& assign(const std_type& str);
    basic_istring& assign(const slice_type& str);
    ...
    // 1) Finds the first substring equal to str. If str.size() is zero, returns
    // pos.
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    find(const String& str, size_type pos = 0) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    rfind(const String& str, size_type pos = npos) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    find_first_of(const String& str, size_type pos = 0) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    find_last_of(const String& str, size_type pos = npos) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    find_first_not_of(const String& str, size_type pos = 0) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, size_type>::type
    find_last_not_of(const String& str, size_type pos = npos) const noexcept;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, int>::type
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, int>::type
    compare(size_type pos1, size_type n1, const String& str) const;
    ...
    template <typename String>
    typename std::enable_if<is_string_class<String>::value, int>::type
    compare(size_type pos1, size_type n1, const String& str, size_type pos2,
            size_type n2) const;
...
template <typename Ch>
std::basic_ostream<Ch>& operator<<(std::basic_ostream<Ch>& ostr,
                                   const basic_istring<Ch>& s);

template <typename Ch>
std::basic_istream<Ch>& operator>>(std::basic_istream<Ch>& istr,
                                   basic_istring<Ch>& s);
...
// 1) Default constructor. Constructs empty string.
template <typename Ch>
constexpr basic_istring<Ch>::basic_istring() noexcept : _core()
{
}
...
basic_istring<Ch>::_substr_length(const String& str, size_type pos, size_type n)
{
    if (pos >= str.size())
    {
...
template <typename Ch>
basic_istring<Ch>::basic_istring(const basic_istring& str, size_type pos,
                                 size_type n)
...
template <typename Ch>
basic_istring<Ch>::basic_istring(const std_type& str, size_type pos,
                                 size_type n)
    : _core(str.data() + pos, _substr_length(str, pos, n))
{
}
...
template <typename Ch>
basic_istring<Ch>::basic_istring(const slice_type& str, size_type pos,
                                 size_type n)
    : _core(str.data() + pos, _substr_length(str, pos, n))
{
}
...
template <typename Ch>
template <class InputIterator>
basic_istring<Ch>::basic_istring(InputIterator begin, InputIterator end)
    : _core(begin, end)
{
}
...
// 4) Replaces the contents with character ch
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::operator=(value_type ch)
{
...
// 5) Replaces the contents with those of the initializer list ilist.
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::
...
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::assign(const_pointer str)
{
    this->_core.copy(str);
    return *this;
}
...
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::assign(const basic_istring& str)
{
    this->_core.copy(str._core);
    return *this;
}
...
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::assign(const std_type& str)
{
    this->_core.assign(str.data(), str.size());
    return *this;
}
...
template <typename Ch>
basic_istring<Ch>& basic_istring<Ch>::assign(const slice_type& str)
{
    this->_core.assign(str.data(), str.size());
    return *this;
}
...
template <typename Ch>
inline typename basic_istring<Ch>::const_iterator basic_istring<Ch>::end() const
    noexcept
{
    return &data()[0] + size();
}
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type basic_istring<Ch>::size() const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type basic_istring<Ch>::length() const
    noexcept
{
    return this->_core.size();
}
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type basic_istring<Ch>::max_size() const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type basic_istring<Ch>::capacity() const
    noexcept
{
...
template <typename Ch>
typename basic_istring<Ch>::slice_type basic_istring<Ch>::
operator()(size_type start) const
{
...
template <typename Ch>
typename basic_istring<Ch>::slice_type basic_istring<Ch>::
operator()(size_type start, size_type end) const
{
    return slice_type(data() + start, data() + end);
}

template <typename Ch>
inline typename basic_istring<Ch>::const_reference basic_istring<Ch>::
...
template <typename Ch>
typename basic_istring<Ch>::const_reference basic_istring<Ch>::front() const
{
    return data()[0];
}

template <typename Ch>
typename basic_istring<Ch>::const_reference basic_istring<Ch>::back() const
{
    return data()[size() - 1];
}
...
template <typename Ch>
basic_istring<Ch> basic_istring<Ch>::substr(size_type pos, size_type n) const
{
    return basic_istring(*this, pos, n);
}

template <typename Ch>
typename basic_istring<Ch>::std_type basic_istring<Ch>::std_str() const
{
    return std::move(std_type(data(), size()));
}

template <typename Ch>
typename basic_istring<Ch>::const_pointer basic_istring<Ch>::c_str() const
    noexcept
{
...
template <typename Ch>
typename basic_istring<Ch>::const_pointer basic_istring<Ch>::data() const
    noexcept
{
    return this->_core.data();
}
...
template <typename Ch>
template <typename String>
inline typename std::enable_if<is_string_class<String>::value,
                               typename basic_istring<Ch>::size_type>::type
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find(const_pointer s, size_type pos, size_type n) const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::rfind(const_pointer s, size_type pos, size_type n) const
    noexcept
{
...
inline typename std::enable_if<is_string_class<String>::value,
                               typename basic_istring<Ch>::size_type>::type
basic_istring<Ch>::find_first_of(const String& str, size_type pos) const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_first_of(const_pointer s, size_type pos,
                                 size_type n) const noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_last_of(const_pointer s, size_type pos,
                                size_type n) const noexcept
{
...
inline typename std::enable_if<is_string_class<String>::value,
                               typename basic_istring<Ch>::size_type>::type
basic_istring<Ch>::find_first_not_of(const String& str, size_type pos) const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_first_not_of(const_pointer s, size_type pos,
                                     size_type n) const noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_first_not_of(const_pointer s, size_type pos) const
    noexcept
{
...
inline typename std::enable_if<is_string_class<String>::value,
                               typename basic_istring<Ch>::size_type>::type
basic_istring<Ch>::find_last_not_of(const String& str, size_type pos) const
    noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_last_not_of(const_pointer s, size_type pos,
                                    size_type n) const noexcept
{
...
template <typename Ch>
inline typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_last_not_of(const_pointer s, size_type pos) const
    noexcept
{
...
template <typename Ch>
typename basic_istring<Ch>::size_type
basic_istring<Ch>::find_last_not_of(value_type c, size_type pos) const noexcept
{
...
template <typename Ch>
template <typename String>
inline typename std::enable_if<is_string_class<String>::value, int>::type
...
template <typename String>
inline typename std::enable_if<is_string_class<String>::value, int>::type
basic_istring<Ch>::compare(size_type pos1, size_type n1,
...
template <typename String>
inline typename std::enable_if<is_string_class<String>::value, int>::type
basic_istring<Ch>::compare(size_type pos1, size_type n1, const String& str,
...
template <typename Ch>
inline int basic_istring<Ch>::compare(size_type pos1, size_type n1,
...
//
template <typename Ch>
inline std::basic_ostream<Ch>& operator<<(std::basic_ostream<Ch>& ostr,
                                          const basic_istring<Ch>& s)
{
...
template <typename Ch>
inline std::basic_istream<Ch>& operator>>(std::basic_istream<Ch>& istr,
                                          basic_istring<Ch>& s)
{
    std::string tmp;
    istr >> tmp;
