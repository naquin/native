...
{
    json_exception(const std::string& message, std::size_t line,
                   std::size_t column)
...
#define NATIVE_JSON_EXCEPTION_DECL(className, messageText)                     \
    ...
    {                                                                          \
        ...
        className(const std::string& message, std::size_t line,                \
                  std::size_t column)                                          \
            : json_exception{messageText ": " + message, line, column}         \
        {                                                                      \
        }                                                                      \
    };

NATIVE_JSON_EXCEPTION_DECL(expected_end_of_stream, "Expected end of stream")
NATIVE_JSON_EXCEPTION_DECL(unexpected_end_of_stream, "Unexpected end of stream")
NATIVE_JSON_EXCEPTION_DECL(expected_object_or_array, "Expected object or array")
NATIVE_JSON_EXCEPTION_DECL(expected_colon_after_key, "Expected colon after key")
...
NATIVE_JSON_EXCEPTION_DECL(expected_null_value, "Expected null value")
NATIVE_JSON_EXCEPTION_DECL(expected_true_value, "Expected true value")
NATIVE_JSON_EXCEPTION_DECL(expected_false_value, "Expected false value")
NATIVE_JSON_EXCEPTION_DECL(incorrect_hex_digit, "Incorrect hex digit")
...
NATIVE_JSON_EXCEPTION_DECL(unknown_escape_character, "Unknown escape character")
NATIVE_JSON_EXCEPTION_DECL(missing_start_quote, "Missig start quote")
NATIVE_JSON_EXCEPTION_DECL(missing_end_quote, "Missing end quote")
NATIVE_JSON_EXCEPTION_DECL(incorrect_unescaped_character,
                           "Incorrect unescaped character")
NATIVE_JSON_EXCEPTION_DECL(invalid_encoding, "Invalid encoding")
NATIVE_JSON_EXCEPTION_DECL(expected_value, "Expected value")
NATIVE_JSON_EXCEPTION_DECL(
    unexpected_signed_value,
