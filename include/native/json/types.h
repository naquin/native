...
template <> struct type_mapper<std::basic_string<char>>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<const char16_t*>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<std::basic_string<char16_t>>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<const char32_t*>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<std::basic_string<char32_t>>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<const wchar_t*>
{
    static constexpr data_type value = type_string;
};

template <> struct type_mapper<std::basic_string<wchar_t>>
{
    static constexpr data_type value = type_string;
};
