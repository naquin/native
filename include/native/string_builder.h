...
public:
    ...
    basic_string_builder(const basic_string_builder& str, size_type pos, size_type n = npos);
    basic_string_builder(const istring_type& str,         size_type pos, size_type n = npos);
    basic_string_builder(const std_type& str,             size_type pos, size_type n = npos);
    basic_string_builder(const slice_type& str,           size_type pos, size_type n = npos);
...
//
template <typename Ch>
constexpr const typename basic_string_builder<Ch>::size_type basic_string_builder<Ch>::npos = -1;

// 1) Default constructor. Constructs empty string.
template <typename Ch>
constexpr basic_string_builder<Ch>::basic_string_builder(size_type capacity) noexcept:
    _core(capacity)
{ }
...
inline typename basic_string_builder<Ch>::size_type
    basic_string_builder<Ch>::_substr_length(
        const String& str, size_type pos, size_type n)
{
    if (pos >= str.size())
    {
...
basic_string_builder<Ch>::basic_string_builder(
    const basic_string_builder& str, size_type pos, size_type n):
...
template <typename Ch>
basic_string_builder<Ch>::basic_string_builder(const istring_type& str, size_type pos, size_type):
    _core(str._core)
{
...
template <typename Ch>
basic_string_builder<Ch>::basic_string_builder(const std_type& str, size_type pos, size_type n):
    _core(str.data() + pos, _substr_length(str, pos, n))
{
...
template <typename Ch>
basic_string_builder<Ch>::basic_string_builder(const slice_type& str, size_type pos, size_type n):
    _core(str.data() + pos, _substr_length(str, pos, n))
{
...
//    pointer.
template <typename Ch>
constexpr basic_string_builder<Ch>::basic_string_builder(const_pointer s, size_type n):
    _core(s, n)
{ }
...
template <typename Ch>
basic_string_builder<Ch>::basic_string_builder(basic_string_builder&& str) noexcept:
    _core(std::move(str._core))
{ }

// 9) Constructs the string with the contents of the initializer list init.
template <typename Ch>
basic_string_builder<Ch>::basic_string_builder(std::initializer_list<value_type> init):
...
template <typename Ch>
typename basic_string_builder<Ch>::slice_type basic_string_builder<Ch>::slice() const noexcept
{
    return slice_type(this->_core.data(), this->_core.data() + this->_core.size());
}
...
// char
template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(short value)
{
    _append_string(std::snprintf, "%hd", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(unsigned short value)
{
    _append_string(std::snprintf, "%hu", value);
    return *this;
}
...
{
    _append_string(std::snprintf, "%d", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(unsigned int value)
{
    _append_string(std::snprintf, "%u", value);
    return *this;
}
...
{
    _append_string(std::snprintf, "%ld", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(unsigned long value)
{
    _append_string(std::snprintf, "%lu", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(long long value)
{
    _append_string(std::snprintf, "%lld", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(unsigned long long value)
{
    _append_string(std::snprintf, "%llu", value);
    return *this;
}

template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(float value)
{
...
template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(double value)
{
    _append_string(std::snprintf, "%f", value);
    return *this;
}
...
template <>
basic_string_builder<char>& basic_string_builder<char>::operator<<(long double value)
{
...
template <typename Ch>
basic_string_builder<Ch>& basic_string_builder<Ch>::operator<<(const_pointer ptr)
{
...
// wchar_t
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(short value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(unsigned short value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(int value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(unsigned int value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(long value)
//{
...
//
//template <>
//basic_string_builder& basic_string_builder<wchar_t>::operator<<(unsigned long value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(long long value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(unsigned long long value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(float value)
//{
...
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(double value)
//{
//    _append_string(std::swprintf, L"%f", value);
//    return *this;
//}
//
//template <>
//basic_string_builder<wchar_t>& basic_string_builder<wchar_t>::operator<<(long double value)
//{
...
template <typename Ch>
basic_string_builder<Ch>& basic_string_builder<Ch>::write(const_pointer s, size_type length)
{
...
template <typename Ch>
template <typename PrintF, typename T>
void basic_string_builder<Ch>::_append_string(PrintF sprintf_like, const_pointer fmt, T value)
{
    ...
    while (true)
    {
        int status = sprintf_like(&_core.mutable_data()[_core.size()], available+1, fmt, value);
        if ( status >= 0 )
        {
...
template <typename Ch>
basic_string_builder<Ch>& operator<< (basic_string_builder<Ch>& s, const typename basic_string_builder<Ch>::string_type& str)
{
...
template <typename Ch>
basic_string_builder<Ch>& operator<< (basic_string_builder<Ch>& s, const typename basic_string_builder<Ch>::istring_type& str)
{
    s.write(str.data(), str.length());
    return s;
}
...
template <typename Ch>
basic_string_builder<Ch>& operator<< (basic_string_builder<Ch>& s, const typename basic_string_builder<Ch>::std_type& str)
{
    s.write(str.data(), str.length());
    return s;
}
...
template <typename Ch>
basic_string_builder<Ch>& operator<< (basic_string_builder<Ch>& s, const typename basic_string_builder<Ch>::slice_type& str)
{
    s.write(str.data(), str.length());
    return s;
}
...
struct hash<native::basic_string_builder<Ch>> {
    std::size_t operator()(const native::basic_string_builder<Ch>& s) const noexcept
    {
