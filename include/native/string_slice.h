...
class basic_string_slice:
    public string_base {
public:
    typedef basic_string_slice<Ch> this_type;
...
typedef basic_string_slice<char>     string_slice;
typedef basic_string_slice<wchar_t>  wstring_slice;
typedef basic_string_slice<char16_t> u16string_slice;
typedef basic_string_slice<char32_t> u32string_slice;
